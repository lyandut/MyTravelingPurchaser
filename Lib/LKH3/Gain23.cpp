...
GainType Gain23()
{
    static thread_local Node *s1 = 0;
    static thread_local short OldReversed = 0;
            ...
            for (Ns2 = s2->CandidateSet; (s3 = Ns2->To); Ns2++) {
                ...
                for (X4 = 1; X4 <= 2; X4++) {
                    ...
                    if (X4 == 1 && s4 != s1 && !Forbidden(s4, s1) &&
                        ...
                        (G3 = G2 - C(s4, s1)) > 0) {
                        Gain =
                            BridgeGain(s1, s2, s3, s4, 0, 0, 0, 0, 0, G3);
                        ...
                        for (X6 = 1; X6 <= 2; X6++) {
                            ...
                            if (!Forbidden(s6, s1) &&
                                ...
                                if (CurrentPenalty > 0 ||
                                    ...
                                    if (Case6 <= 2 || Case6 == 5 ||
                                        Case6 == 6) {
                                        Make3OptMove(s1, s2, s3, s4, s5,
                                                     s6, Case6);
                                        if (Improvement(&Gain6, s1, s2))
                                            return Gain6;
                                    }
                                }
                                Gain =
